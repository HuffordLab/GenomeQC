  ...
  Nvalues_plot1 <- eventReactive(input$go1,{
    ...
    if (!is.null(input$fasta_file1$datapath)) {
      if(!is.null(input$references1)) {
        ...
        u_num <- ran_number1()
        output_NG <- paste0("file", u_num,"_NG.txt")
        NGX_threshold <- c(1:100)
     ...
     # If the user does not select any reference genome 
        ...
        NGX_scaffoldlength <- c(NGX_test, NA_vector)
        user_n <- log(NGX_scaffoldlength)
        comb <- as.data.frame(user_n)
        colnames(comb) <- user_name
        xdata <- NGX_threshold
        NGXdata <- data.frame(xdata, comb)
        xymelt <- melt(NGXdata, id.vars = "xdata")
               ...
               
               {
                 ...
                 if (input$lengthmetrics_rows_selected == 13 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[13,]), main="N50",xlab="genomes", ylab="N50 value (bp)", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 1 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({
                       ...
                       barplot(g ,xlab="genomes", ylab="Number of sequences", names.arg=cn, col=rainbow(len))
                     })
                 ...
                 if (input$lengthmetrics_rows_selected == 2 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[2,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 3 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({
                       barplot(as.numeric(data_fr[3,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 4)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[4,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 5)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[5,]),xlab="genomes", ylab="useful estimated genome size (%)", names.arg=cn, col=rainbow(len))})                    
                 ...
                 if (input$lengthmetrics_rows_selected == 6)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[6,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 7)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[7,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 8)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[8,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 9)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[9,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 10)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[10,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 11)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[11,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 12)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[12,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 14)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[14,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 15)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[15,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 16)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[16,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 17)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[17,]) ,xlab="genomes", ylab="%A", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 18)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[18,]) ,xlab="genomes", ylab="%C", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 19)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[19,]) ,xlab="genomes", ylab="%G", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 20)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[20,]) ,xlab="genomes", ylab="%T", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 21)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[21,]) ,xlab="genomes", ylab="Number of Ns", names.arg=cn, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics_rows_selected == 22)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr[22,]) ,xlab="genomes", ylab="%N", names.arg=cn, col=rainbow(len))})
               ...
               
               {
                 ...
                 if (input$lengthmetrics1_rows_selected == 13 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[13,]), main="N50",xlab="genomes", ylab="N50 value (bp)", names.arg=cn2, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics1_rows_selected == 1 )
                 {
                   showModal(modalDialog(
                     ...
                     barplot(g ,xlab="genomes", ylab="Number of sequences", names.arg=cn2, col=rainbow(len))
                    })
                 ...
                 if (input$lengthmetrics1_rows_selected == 2 )
                 {
                   showModal(modalDialog(
                    ...
                    outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[2,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn2, col=rainbow(len))})
                ...
                if (input$lengthmetrics1_rows_selected == 3 )
                 {
                   showModal(modalDialog(
                    ...
                    outputplot1 <- renderPlot({
                    barplot(as.numeric(data_fr1[3,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn2, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics1_rows_selected == 4)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[4,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn2, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics1_rows_selected == 5)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[5,]),xlab="genomes", ylab="useful estimated genome size (%)", names.arg=cn2, col=rainbow(len))})                    
                 ...
                 if (input$lengthmetrics1_rows_selected == 6)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[6,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn2, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics1_rows_selected == 7)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[7,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn2, col=rainbow(len))})
                 ...
                 if (input$lengthmetrics1_rows_selected == 8)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[8,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn2, col=rainbow(len))})
                ...
                if (input$lengthmetrics1_rows_selected == 9)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[9,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 10)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[10,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 11)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[11,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 12)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[12,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 14)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[14,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 15)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[15,]) ,xlab="genomes", ylab="scaffold length (bp)", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 16)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[16,]) ,xlab="genomes", ylab="Number of scaffolds", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 17)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[17,]) ,xlab="genomes", ylab="%A", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 18)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[18,]) ,xlab="genomes", ylab="%C", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 19)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[19,]) ,xlab="genomes", ylab="%G", names.arg=cn2, col=rainbow(len))})
                ...
                if (input$lengthmetrics1_rows_selected == 20)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[20,]) ,xlab="genomes", ylab="%T", names.arg=cn2, col=rainbow(len))})
                ...
                if (input$lengthmetrics1_rows_selected == 21)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[21,]) ,xlab="genomes", ylab="Number of Ns", names.arg=cn2, col=rainbow(len))})
               ...
               if (input$lengthmetrics1_rows_selected == 22)
                 {
                   showModal(modalDialog(
                     ...
                     outputplot1 <- renderPlot({barplot(as.numeric(data_fr1[22,]) ,xlab="genomes", ylab="%N", names.arg=cn2, col=rainbow(len))})
               ...
               
               {
                 ...
                 if (input$annotationmetrics_rows_selected == 1 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[1,]),xlab="genomes", ylab="Number of gene models", names.arg=cg, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics_rows_selected == 2 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[2,]), xlab="genomes", ylab="Gene length (bp)", names.arg=cg, col=rainbow(len))
                     })
                 ...
                 if (input$annotationmetrics_rows_selected == 3 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[3,]) ,xlab="genomes", ylab="Gene length (bp)", names.arg=cg, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics_rows_selected == 4 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[4,]) ,xlab="genomes", ylab="Gene length (bp)", names.arg=cg, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics_rows_selected == 5 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[5,]) ,xlab="genomes", ylab="number of exons", names.arg=cg, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics_rows_selected == 6 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[6,]) ,xlab="genomes", ylab="Average number of exons per gene model", names.arg=cg, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics_rows_selected == 7 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[7,]) ,xlab="genomes", ylab="Average exon length (bp)", names.arg=cg, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics_rows_selected == 8 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[8,]) ,xlab="genomes", ylab="Number of transcripts", names.arg=cg, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics_rows_selected == 9 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[9,]) ,xlab="genomes", ylab="Average number of transcripts per gene model", names.arg=cg, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics_rows_selected == 10 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[10,]) ,xlab="genomes", ylab="Number of Gene models less than 200bp length", names.arg=cg, col=rainbow(len))})
  ...
  data_gff1 <- eventReactive(input$go2,{
    ...
    if (!is.null(input$gff_file$datapath)) {
      ...
      if(!is.null(input$references2)) {
        ...
        system(paste("python /home/nancy/assembly_app/gff3_stats.py", example_file.gff, output_gff_metrics), intern = TRUE)
               ...
               
               {
                 ...
                 if (input$annotationmetrics1_rows_selected == 1 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[1,]),xlab="genomes", ylab="Number of gene models", names.arg=cg2, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics1_rows_selected == 2 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[2,]), xlab="genomes", ylab="Gene length (bp)", names.arg=cg2, col=rainbow(len))
                     })
                 ...
                 if (input$annotationmetrics1_rows_selected == 3 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[3,]) ,xlab="genomes", ylab="Gene length (bp)", names.arg=cg2, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics1_rows_selected == 4 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[4,]) ,xlab="genomes", ylab="Gene length (bp)", names.arg=cg2, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics1_rows_selected == 5 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[5,]) ,xlab="genomes", ylab="number of exons", names.arg=cg2, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics1_rows_selected == 6 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[6,]) ,xlab="genomes", ylab="Average number of exons per gene model", names.arg=cg2, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics1_rows_selected == 7 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[7,]) ,xlab="genomes", ylab="Average exon length (bp)", names.arg=cg2, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics1_rows_selected == 8 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[8,]) ,xlab="genomes", ylab="Number of transcripts", names.arg=cg2, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics1_rows_selected == 9 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[9,]) ,xlab="genomes", ylab="Average number of transcripts per gene model", names.arg=cg2, col=rainbow(len))})
                 ...
                 if (input$annotationmetrics1_rows_selected == 10 )
                 {
                   showModal(modalDialog(
                     ...
                     outputplot2 <- renderPlot({barplot(as.numeric(data_ann[10,]) ,xlab="genomes", ylab="Number of Gene models less than 200bp length", names.arg=cg2, col=rainbow(len))})
...
## THIS MODULE PLOTS AND EMAIL THE PRE-COMPUTED REFERENCE GENOME BUSCO SCORES
  ...
  reference_busco <- eventReactive(input$go,{
    ...
    if (is.null(input$references))
    {
      ...
      system(paste("python /home/nancy/assembly_app/busco-master/scripts/no_fasta_gff.py", email_id, output_busco_asssemblyplot, output_busco_gffplot, REF_NAM), intern = TRUE)
  ...
  output$reference_busco_plots <- renderPrint({
    ...
    {
      HTML(paste0("<span style=\"color:red\">",print_m,"</span>"))
...
## THIS MODULE CALCULATES, PLOTS, AND EMAIL THE BUSCO SCORES AND CONTAMINATION SCORE FOR THE USER UPLOADED GENOME ASSEMBLY AND COMPARE THE VALUES WITH PRE-COMPUTED REFERENCE VALUES  
  ...
  assembly_busco <- eventReactive(input$go1,{
    ...
    if(!is.null(input$references1)) {
      ...
      example_file.fasta <- input_fasta_file1()
      u_num <- ran_number1()
      output_name <- paste0("file", u_num,"_busco")
      ...
      future(system(paste("bash /home/nancy/assembly_app/busco-master/scripts/assembly_contamination.sh", example_file.fasta, output_name, b_name, species_name, email_id, input_name, REF_NAM), intern = TRUE))
    ...
    # If the user does not select any reference genome 
      ...
      future(system(paste("bash /home/nancy/assembly_app/busco-master/scripts/noref_assembly_contamination.sh", example_file.fasta, output_name, b_name, species_name, email_id, input_name), intern = TRUE))
      message = "Your job has been submitted"
      return(message)
    }
  ...
  annotation_busco <- eventReactive(input$go2,{
    ...
    if(!is.null(input$references2)) 
    {
      ...
      if(!is.null(input$transcripts_file$datapath))
      {
        ...
        future(system(paste("bash /home/nancy/assembly_app/busco-master/scripts/annotation.sh", input_transcripts.fasta, output_namegff, b_name, email_id, input_name, REF_NAM), intern = TRUE))
        message = "Your job has been submitted"
        return(message)
      }
      ...
      else 
      {
        ...
        else 
        {
          ...
          future(system(paste("bash /home/nancy/assembly_app/busco-master/scripts/annotation.sh", transcripts_output, output_namegff, b_name, email_id, input_name, REF_NAM), intern = TRUE))
          message = "Your job has been submitted"
          return(message)
        }
      }
    ...
    else 
    {
      ...
      if(!is.null(input$transcripts_file$datapath))
      {
        ...
        future(system(paste("bash /home/nancy/assembly_app/busco-master/scripts/noref_annotation.sh", input_transcripts.fasta, output_namegff, b_name, email_id, input_name), intern = TRUE))
        message = "Your job has been submitted"
        return(message)
      }
      ...
      else 
      {
        ...
        else 
        {
          ...
          future(system(paste("bash /home/nancy/assembly_app/busco-master/scripts/noref_annotation.sh", transcripts_output, output_namegff, b_name, email_id, input_name), intern = TRUE))
          message = "Your job has been submitted"
          return(message)
        }
      }
