...
def _parse_args():
    ...
    optional.add_argument('-ref', '--references', required=False, help='provide reference names')

    optional.add_argument('-id', '--email', required=False, help='provide provide email ID')

    optional.add_argument('-user_name', '--user_name', required=False, help='provide provide name of analysis')
