...
#reads the calculated busco scores from the summary file for the user uploaded genome assembly   
f=open(summary_file)
lines=f.readlines()
b = lines[7]
...
busco_plot_name = output_name + "assembly_plot.html"
