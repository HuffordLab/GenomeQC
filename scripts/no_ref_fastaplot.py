...
"""
This script plots and email the scores for the user uploaded genome assembly 

Usage: python no_ref_fastaplot.py <email address> <name for output plot> <busco output directory name> 
...
busco_plot_name = output_name + "assembly_NoRef_plot.html"
