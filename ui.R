  ...
  tabPanel("Compare reference genomes",               
    sidebarLayout(
      sidebarPanel(
        ...
        helpText(HTML('<p style="color:black; fontsize: 9pt">Please note: For Brassica rapa genome - no information was provided about the exon coordinates in the publicly available annotation file.</p>')),
        div(
          ...
          choices = c("MaizeMo17_CAU_scaffolds", "MaizeB73_v4_scaffolds", "MaizeW22_NRgene_con", "Sorghum_bicolor_NCBIv3_con", "Rice_japonica_Nipponbare4.0_chr", "Arabidopsis_thaliana_TAIR10.1_chr", "Brassica_rapa_v3_chr", "Brachypodium_distachyon_v3_con", "Setaria_italica_v2_chr", "Glycine_max_v2.1_con"),
            options = list(
              `actions-box` = TRUE, 
              size = 10,
    ...
    tabPanel("Analyze your genome assembly", fluid = TRUE,
               ...
               sidebarPanel(
                 ...
                 div(
                   div(style="width:90%; display:inline-block; vertical-align: middle;", pickerInput(
                     ...
                     choices = c("MaizeMo17_CAU_scaffolds", "MaizeB73_v4_scaffolds", "MaizeW22_NRgene_con", "Sorghum_bicolor_NCBIv3_con", "Rice_japonica_Nipponbare4.0_chr", "Arabidopsis_thaliana_TAIR10.1_chr", "Brassica_rapa_v3_chr", "Brassica_napus_v4","Brassica_napus_Tapidor_v63","Brassica_napus_Darmor_v81","Brachypodium_distachyon_v3_con", "Setaria_italica_v2_chr", "Glycine_max_v2.1_con"),         
                     options = list(
                       `actions-box` = TRUE, 
                       size = 10,
                       `selected-text-format` = "count > 3"
        ...
        div(
          ...
          div(style="display:inline-block;vertical-align:top;", bsButton("q9", label = "", icon = icon("info"), style = "info", size = "extra-small"))),
        ...
        bsPopover(id = "q10", title = "",
                  ...
                  placement = "top",
                  trigger = "click",  options=list(container="body")),
        helpText(HTML('<p style="color:black; font-weight:bold; fontsize: 14pt">OPTIONAL: if you want to compare a second genome assembly please complete the next two options: </p>')),
        helpText(HTML('<p style="color:red; fontsize: 9pt">Provide just one word for the name</p>')),

        #helpText(HTML('<p style="color:black; fontsize: 14pt">OPTIONAL: if you want to compare a second genome assembly please complete the next two options: </p>')),
                div(
          div(style="display:inline-block;vertical-align:top;",  textInput("user_input3", label = HTML('<p> Name of your genome assembly2</p>'), value = "")),
        ...
        div(
          ...
          div(style="display:inline-block; vertical-align: top;", bsButton("q11", label = "", icon = icon("info"), style = "info", size = "extra-small", shape = "circular"))
        ),
             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 div(
                   ...
                   div(style="display:inline-block; vertical-align: top;", bsButton("q16", label = "", icon = icon("info"), style = "info", size = "extra-small", shape = "circular"))
                 ),
...
https://www.ncbi.nlm.nih.gov/genome/167?genome_assembly_id=161521 .As an alternative, you could upload a corresponding transcript fasta file in addition to the GFF file.</p>')),
        ...
        div(
          div(style="width:90%; display:inline-block; vertical-align: middle;", fileInput("transcripts_file", "Upload Transcripts Fasta File (.gz compression format)",
                                                                                          accept = ".gz")),
          div(style="display:inline-block;vertical-align:top;", bsButton("q18", label = "", icon = icon("info"), style = "info", size = "extra-small"))),
          bsPopover(id = "q18", title = "",
    ...
    tags$head(
        ...
        tags$meta(property="og:image", content="https://genomeqc.maizegdb.org/gqc_white_background_transparent_icon1.jpg")
    )
)
